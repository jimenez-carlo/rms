...
<div class="container-fluid form-horizontal">
    ...
    <div class="block span10">
      <div class="navbar navbar-inner block-header">
        <div class="pull-left"><?php if(isset($tid)) print $topsheet->trans_no; ?> Topsheet</div>
      </div>
      <div class="block-content collapse in">
        <?php 
        if(isset($tid))
        ...
        <table class="table tbl-sales" style="margin:0;">
            ...
            <tbody>
                ...
                foreach ($topsheet->sales as $sales)
                {
                    ...
                    if ($sales->acct_status == 1) print '<tr class="sales error">';
                    else if ($sales->acct_status == 2) print '<tr class="sales warning">';
                    ...
                    <tr class="attachments hide">
                        ...
                        if (!empty($sales->files))
                        {
                            ...
                            {
                                $path = $dir.'rms_dir/scan_docs/'.$sales->sid.'_'.$sales->engine_no.'/'.$file;
                        ...
                        <div class="span4" style="position:fixed; top:10%; right:10%;">
                            ...
                            <div class="form-actions">
                                <a href="<?php print $dir; ?>orcr_checking/check/<?php print $sales->sid; ?>" class="btn btn-success" onclick="return confirm('Are you sure you want to confirm?');">Confirm</a>
                ...
                <div class="span6" style="margin-left:5em">
                    ...
                    <table class="table misc">
                        <tbody>
                            <tr>
                                <td>Meal:</td>
                                <td><p class="text-right"><?php print number_format($topsheet->meal, 2, ".", ""); ?></p></td>
                            </tr>
                            <tr>
                                <td>Photocopy:</td>
                                <td><p class="text-right"><?php print number_format($topsheet->photocopy, 2, ".", ""); ?></p></td>
                            </tr>
                            <tr>
                                <td>Transportation:</td>
                                <td><p class="text-right"><?php print number_format($topsheet->transportation, 2, ".", ""); ?></p></td>
                            </tr>
                            <tr>
                                <td>Others:</td>
                                <td><p class="text-right"><?php print number_format($topsheet->others, 2, ".", ""); ?></p></td>
                            </tr>
                            <tr>
                                <th>Total Miscellaneous:</th>
                                <th><p class="text-right"><?php print number_format($topsheet->total_misc, 2, ".", ""); ?></p></th>
                            </tr>
                            <tr>
                                <td>Remarks:</td>
                                <td>
