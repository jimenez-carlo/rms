        ...
        <div class="row-fluid">
                <div class="block">
                        <div class="navbar navbar-inner block-header">
                                <div class="pull-left">For Deposit E-Payment</div>
                        </div>
                                ...
                                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                        ...
                                        <table class="table">
                                                ...
                                                <tbody>
                                                        ...
                                                        {
                                                                print '<tr>';
                                                                print '<td><input type="checkbox" class="'.$class_checkbox.'" name="epid[]" value="'.$row->epid.'"></td>';
                                                                print '<td>'.$row->ref_date.'</td>';
                                                                print '<td><a href="'.base_url().'electronic_payment/view/'.$row->epid.'" target="_blank">'.$row->reference.'</a></td>';
