...
<h4>List of Branch Total Registration Expense, Miscellaneous Expense,
<br>and Expense Summary in a Region and Company<br>(Topsheet)</h4>
        ...
        <fieldset>
            ...
            <table class="table" style="margin:20px 0px;clear:both;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php print $sales->bcode.' '.$sales->bname; ?></td>
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <span style="float:right"><?php print number_format($topsheet->misc->meal, 2, ".", ","); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <span style="float:left">Photocopy:</span>
                            <span style="float:right"><?php print number_format($topsheet->misc->photocopy, 2, ".", ","); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <span style="float:left">Transportation:</span>
                            <span style="float:right"><?php print number_format($topsheet->misc->transportation, 2, ".", ","); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <span style="float:left">Others: <?php if (!empty($topsheet->others_specify)) print '('.$topsheet->others_specify.')'; ?> </span>
                            <span style="float:right"><?php print number_format($topsheet->misc->others, 2, ".", ","); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <th>
                            <span style="float:left">Total Miscellaneous:</span>
                            <span style="float:right">&#x20b1 <?php print number_format($topsheet->misc->total, 2, ".", ","); ?></span>
                        </th>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    ...
                    <tr>
                        <th>
                            ...
                            <span style="float:right">&#x20b1 <?php print number_format($topsheet->total_expense + $topsheet->misc->total, 2, ".", ","); ?></span>
                        </th>
                    </tr>
                    <tr>
                        <th>
