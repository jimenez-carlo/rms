        ...
        <form class="form-horizontal" method="post" style="margin:0px;">
          ...
          <table class="table">
            ...
            <tbody>
              ...
              {
                print '<tr>';
                print '<td>'.form_checkbox('mid['.$misc->mid.']', $misc->mid, FALSE).'</td>';
          ...
          <fieldset>
            ...
            <div class="span7">
	            <div class="control-group hide">
	              ...
	              <div class="controls text ts-exp"><?php print $topsheet->total_expense; ?></div>
	            </div>
	            <div class="control-group">
	              <label class="control-label">Total Amount</label>
	              <div class="controls text tot-amt"><?php print $topsheet->total_amount; ?></div>
	            </div>
	            <div class="control-group">
...
$(function(){
	function compute() {
    var tot_meal = toFloat($(".tot-meal").text());
    var tot_photo = toFloat($(".tot-photo").text());
    var tot_trans = toFloat($(".tot-trans").text());
    var tot_other = toFloat($(".tot-other").text());
    var tot_misc = toFloat($(".tot-misc").text());
  ...
  $(document).ready(function(){
    $('table input').click(function(){
      ...
      $(".tot-trans").text(commafy(tot_trans));
      $(".tot-other").text(commafy(tot_other));
      $(".tot-misc").text(commafy(tot_meal+tot_photo+tot_trans+tot_other));
      compute();
    });
    compute();
  });
