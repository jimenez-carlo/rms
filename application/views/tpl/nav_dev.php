            ...
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            <li <?php if(isset($nav) && $nav=="cron") echo 'class="active"'; ?>>
                                <a href="<?php if(isset($dir)) echo $dir; ?>cron">Cron</a>
                            </li>
                            <li <?php if(isset($nav) && $nav=="settings") echo 'class="active"'; ?>>
                                <a href="<?php if(isset($dir)) echo $dir; ?>page_access">Page Access</a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
