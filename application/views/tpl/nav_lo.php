                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            <li <?php if(isset($nav) && $nav=="transmittal") echo 'class="active"'; ?>>
                                <a href="<?php if(isset($dir)) echo $dir; ?>transmittal/expense">Transmittal</a>
                            </li>
                            <li <?php if(isset($nav) && $nav=="miscellaneous") echo 'class="active"'; ?>>
                                <a href="<?php if(isset($dir)) echo $dir; ?>miscellaneous">Miscellaneous</a>
                            </li>
