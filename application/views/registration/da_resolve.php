    ...
    <div class="block">
      ...
      <div class="block-content collapse in">
            ...
            if (isset($sales))
            {
              ...
              switch ($sales->da_reason)
              {
                ...
                case 3: // invalid si/ar
                  print '<div class="control-group">';
                  print '<div class="control-label">SI #</div>';
                  print '<div class="controls">'.form_input('si_no', set_value('si_no', $sales->si_no)).'</div>';
                  print '</div>';

                  print '<div class="control-group">';
                  print '<div class="control-label">AR #</div>';
                  print '<div class="controls">'.form_input('ar_no', set_value('ar_no', $sales->ar_no)).'</div>';
                  print '</div>';
                  break;
		...
		8  => 'Mismatch CR #',
              ...
              print '<div class="control-group">';
              print '<div class="control-label">Reason for Disapprove</div>';
              print '<div class="controls">'.$da_reason[$sales->da_reason].'</div>';
              print '</div>';

              print '<div class="form-actions">';
              print form_submit('submit', 'Save and Resolve', array('class' => 'btn btn-success', 'onclick' => "return confirm('Please make sure all information are correct before proceeding. Continue?')"));
              print '</div>';
            }
            else
            {
