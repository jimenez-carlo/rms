...
<form action="#" id="form" class="form-horizontal" style="margin:0px!important;">
  ...
  <div class="control-group">
    <label class="control-label">Debit Memo #</label>
		<div class="controls text"><?php print $voucher->dm_no; ?></div>
  </div>
	<div class="control-group">
	...
	<div class="control-group hide date">
		...
		<div class="controls">
			<input type="text" name="transfer_date" class="datepicker" data-format="yyyy-mm-dd" value="<?php print date("Y-m-d"); ?>">
		</div>
	</div>
	<div class="control-group">
