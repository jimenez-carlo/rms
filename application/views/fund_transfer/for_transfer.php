          ...
          <table class="table">
            ...
            <tbody>
              ...
              foreach ($table as $row)
              {
                ...
                print '<td>'.form_input('transfer_date['.$row->vid.']', set_value('transfer_date['.$row->vid.']'), array('class' => 'datepicker', 'disabled' => '')).'</td>';
                // print '<td>'.$row->company.'</td>';
                // print '<td style="text-align:center"><button class="btn btn-success" onclick="transfer_fund('.$row->vid.')">Transfer Fund</button></td>';
                print '</tr>';
              }
...
function transfer_fund(_vid)
{
  vid = _vid;

  $.ajax({
    url : "transfer_fund/" + vid,
    type: "POST",
    dataType: "JSON",
