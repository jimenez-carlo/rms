      ...
      <div class="block-content collapse in">
        ...
        <table class="table" style="margin-top:10px;margin-bottom:0px;">
          <tbody> 
            ...
            print '
              <tr><td>RRT PENDING</td><td>'.$new.'</td></tr>
              <tr><td>REJECTED</td><td>'.$rejected.'</td></tr>
              <tr><td>LTO PENDING</td><td>'.$pending.'</td></tr>
              <tr><td>NRU</td><td>'.$nru.'</td></tr>
      ...
      <div class="block-content collapse in">
        ...
        <table class="table" style="margin-top:10px;margin-bottom:0px;">
          ...
          <tfoot>
            <tr>
              <th>TOTAL</th>
              <th><?php print ($ts_unprocessed + $ts_incomplete + $ts_sap_upload + $ts_done); ?></th>
            </tr>
          </tfoot>
        </table>
      </div>
