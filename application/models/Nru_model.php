...
class Nru_model extends CI_Model{
  ...
  {
    return $this->db->query("SELECT cash_on_hand FROM tbl_fund WHERE region = ".$data['region'])->row()->cash_on_hand;
  }
  ...
  public function update_payment_method($sid)
  {
    return $this->db->update('tbl_sales', ['payment_method' => 'CASH'], ['sid'=>$sid]);
  }
