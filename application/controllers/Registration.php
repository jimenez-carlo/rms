...
class Registration extends MY_Controller {
	...
	public function index()
	{
		...
		if ($da_resolve) $this->template('registration/da_resolve', $data);
		else $this->template('registration/view', $data);
	}
...
if (!isset($form_valid)) $form_valid = $this->form_validation->run();
  	...
  	if ($form_valid && empty($err_msg)) $this->submit_save($sales);
  	else $_SESSION['warning'] = $err_msg;
	}
